...
```{r sim1}
sim1 <- niehs_outer(dat, outcome, confound, covar, cp1 = 0.02, nfac = 4)
```
...
```{r sim2}
sim2 <- niehs_outer(dat, outcome, confound, covar, cp1 = 0, nfac = 6)
```
...
real <- niehs_outer(dat, outcome, confound, covar, cp1 = 0.03, nfac = 4, log1 = T)
```
