...
pdf(file.path(p1, "fig1b.pdf"), height = 5.5, width = 10)
 plot_reg_outer(sim1, size1b, size2b)  + theme(text = element_text(size = size1, line = line1))
graphics.off()
...
plot_reg_outer(sim2, size1b, size2b)  + theme(text = element_text(size = size1))
graphics.off()
...
plot_reg_outer(real, size1b, size2b) + theme(text = element_text(size = size1))
graphics.off()
